package codebook.dataStructures.heap;

import java.util.Arrays;

public class BinaryHeapArrays {
	...
	public static void main(String[] args) {
		...
		new BinaryHeapArrays().buildMaxHeap(heapArray, heapArray.length);
		System.out.println("After heapify: "+Arrays.toString(heapArray));		


        // Min Heap -  Uncomment the code.
        // int[] heapArray = { 31, 11, 7, 12, 15, 14, 9, 2, 3, 16 };
		// System.out.println("Before heapify: "+Arrays.toString(heapArray));		
		// new BinaryHeapArrays().buildMinHeap(heapArray, heapArray.length);
		// System.out.println("After heapify: "+Arrays.toString(heapArray));
	}
}